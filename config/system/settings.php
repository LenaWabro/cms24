...
return [
    'BE' => [
        'debug' => true,
        'installToolPassword' => '$argon2i$v=19$m=65536,t=16,p=1$elpZZ25BMXBOY3JmdFoxbQ$/O+mv0PVKxceVdAl14KYz6YLzV5Mg9mZcwAhrSfU6xY',
        'passwordHashing' => [
    ...
    'EXTENSIONS' => [
        ...
        'mask' => [
            ...
            'json' => 'EXT:kwm24/Configuration/Mask/mask.json',
    ...
    'MAIL' => [
        'defaultMailFromAddress' => 's2310456027@fhooe.at',
        'defaultMailFromName' => 'Portfolio Lena Wabro',
        'transport' => 'sendmail',
    ...
    'SYS' => [
        ...
        'devIPmask' => '*',
        'displayErrors' => 1,
        'encryptionKey' => '691134f2c2a10e925dd13f8c4a81161360f88fe331c3320d554aa5460468e38b8e27f9e279c9e019c5d1249db0e4dc80',
